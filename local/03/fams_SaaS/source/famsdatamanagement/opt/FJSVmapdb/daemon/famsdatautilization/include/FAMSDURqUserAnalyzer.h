...
namespace famsdatautil {
    ...
    /*!
     * @class FAMSDURqUserAnalyzer
     * @brief Perform analyzing for input of sensor info search request
     */
    class FAMSDURqUserAnalyzer : public mdbcom::MDBContentAnalyzer {
    public:
        /*!
         ...
         * @return None.
         */
        FAMSDURqUserAnalyzer(mdbcom::MDBContentParser *parser);
