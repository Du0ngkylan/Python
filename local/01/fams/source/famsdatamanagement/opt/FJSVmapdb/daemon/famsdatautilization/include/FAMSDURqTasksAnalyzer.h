...
namespace famsdatautil {
    ...
    /*!
     * @class FAMSDURqTasksAnalyzer
     * @brief Perform analyzing for input of sensor info search request
     */
    class FAMSDURqTasksAnalyzer : public mdbcom::MDBContentAnalyzer {
    public:
        /*!
         ...
         * @return None.
         */
        FAMSDURqTasksAnalyzer(mdbcom::MDBContentParser *parser);
