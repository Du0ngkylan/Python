...
/*
 * @file		FAMSDRWaterTankRequestHandler.h
 * @brief		Header for class FAMSDRWaterTankRequestHandler
 * @author		anhnguyen
 * @date        2018/12/11
 */

#ifndef FAMS_DATA_RECEIVER_REQUEST_HANDLER_H_
#define FAMS_DATA_RECEIVER_REQUEST_HANDLER_H_
...
namespace famsdatareception {
    /*!
     * @class FAMSDRWaterTankRequestHandler
     * @brief The class supports Mod MessageType(Object) info at MAPDB.
     */
    class FAMSDRWaterTankRequestHandler: public FAMSDRBaseHandler { /*pgr2252*/
    public:
        /*!
         ...
         * @return None.
         */
        explicit FAMSDRWaterTankRequestHandler(mdbcom::MDBIPCShm *sharedMemory,
         ...
         * @return None.
         */
        FAMSDRWaterTankRequestHandler(
            const FAMSDRWaterTankRequestHandler &) = delete; /*pgr2222*/
         ...
         * @return None.
         */
        FAMSDRWaterTankRequestHandler &operator=(
            const FAMSDRWaterTankRequestHandler &) = delete; /*pgr0055*//*pgr0309*//*pgr2223*/
         ...
         * @return None.
         */
        ~FAMSDRWaterTankRequestHandler(void) = default;
        /*!
    ...
    private:
        ...
        //! the request data
        famscommon::FAMSWaterReplaceData mRequestData;
...
#endif /* FAMS_DATA_RECEIVER_REQUEST_HANDLER_H_ */
