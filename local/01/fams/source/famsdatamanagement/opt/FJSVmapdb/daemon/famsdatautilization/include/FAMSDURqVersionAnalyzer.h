...
/*!
 * @file        FAMSDURqVersionAnalyzer.h
...
namespace famsdatautil {
    ...
    /*!
     * @class FAMSDURqVersionAnalyzer
     * @brief Perform analyzing for input of sensor info search request
     */
    class FAMSDURqVersionAnalyzer : public mdbcom::MDBContentAnalyzer {
    public:
        /*!
         ...
         * @return None.
         */
        FAMSDURqVersionAnalyzer(mdbcom::MDBContentParser *parser);
