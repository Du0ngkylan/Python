...
/*
 * @file		FAMSDRNitrificationRequestHandler.h
 * @brief		Header for class FAMSDRNitrificationRequestHandler
 * @author		anhnguyen
 * @date        2018/12/11
 */

#ifndef FAMS_DATA_RECEIVER_NITRIFICATION_REQUEST_HANDLER_H_
#define FAMS_DATA_RECEIVER_NITRIFICATION_REQUEST_HANDLER_H_
...
namespace famsdatareception {
    /*!
     * @class FAMSDRNitrificationRequestHandler
     * @brief The class supports Mod MessageType(Object) info at MAPDB.
     */
    class FAMSDRNitrificationRequestHandler: public FAMSDRBaseHandler { /*pgr2252*/
    public:
        /*!
         ...
         * @return None.
         */
        explicit FAMSDRNitrificationRequestHandler(mdbcom::MDBIPCShm *sharedMemory,
         ...
         * @return None.
         */
        FAMSDRNitrificationRequestHandler(
            const FAMSDRNitrificationRequestHandler &) = delete; /*pgr2222*/
         ...
         * @return None.
         */
        FAMSDRNitrificationRequestHandler &operator=(
            const FAMSDRNitrificationRequestHandler &) = delete; /*pgr0055*//*pgr0309*//*pgr2223*/
         ...
         * @return None.
         */
        ~FAMSDRNitrificationRequestHandler(void) = default;
    ...
    private:
        ...
        //! the request data
        famscommon::FAMSNitrificationData mRequestData;
