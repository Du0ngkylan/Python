...
namespace famseventprocessing {
    ...
    extern const std::string CISTERN_SENSOR_THREAD_NAME;
    extern const std::string NITRIFICATION_SENSOR_THREAD_NAME;
    extern const std::string OUTSIDE_SENSOR_THREAD_NAME;
    extern const std::string SENSOR_ADD_THREAD_NAME;
    ...
    public:
        ...
        inline const std::string &getPort(void) const {
            return mStringKeyMap[PORT];
        }
        ...
        inline const std::string &getSQLstatement(const std::string &portName) const {
			auto portValue = mPortTypeKeyMap[portName];
            return famseventprocessing::SQLstatementsMap[portValue].first;
        }

		inline int getNumberOfParameters(const std::string& portName) const {
			auto portValue = mPortTypeKeyMap[portName];
			return famseventprocessing::SQLstatementsMap[portValue].second;
		}

	    const std::set<int> getPortTypes() const {
			std::set<int> types;
			for (auto& i : mPortTypeKeyMap) {
				types.insert(i.second);
			}
			return types;
		}

		const int getPortType(const std::string& portName) const {
			return mPortTypeKeyMap[portName];
		}
    ...
    private:
        ...
        static const std::string CISTERN_SENSOR_THREADS_KEY;
        static const std::string NITRIFICATION_SENSOR_THREADS_KEY;
        static const std::string OUTSIDE_SENSOR_THREADS_KEY;
        static const std::string SENSOR_ADD_THREADS_KEY;
        static const std::string RECEPTION_THREADS_KEY;
        static const std::string SENSOR_SHM_SIZE_KEY;
        static const std::string CISTERN_SENSOR_SHM_SIZE_KEY;
        static const std::string NITRIFICATION_SENSOR_SHM_SIZE_KEY;
        static const std::string OUTSIDE_SENSOR_SHM_SIZE_KEY;
        static const std::string SENSOR_ADD_SHM_SIZE_KEY;
        ...
        //! map to hold port type and value
        static std::map<std::string, int> mPortTypeKeyMap;
