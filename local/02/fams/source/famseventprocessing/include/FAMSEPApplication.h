...
namespace famseventprocessing {
    ...
    public:
         ...
         * @return None.
         */
        static void sensorCisternHandler(void *args);
        /*!
         * @brief thread function of obstacle detection processing threads
         * @param [in] args input parameter
         * @return None.
         */
        static void sensorOutsideHandler(void *args);
        /*!
         * @brief thread function of obstacle detection processing threads
         * @param [in] args input parameter
         * @return None.
         */
        static void sensorNitrificationnHandler(void *args);
        /*!
         * @brief thread function of obstacle detection processing threads
         * @param [in] args input parameter
         * @return None.
         */
        static void sensorAddHandler(void *args);
    ...
    private:
        ...
        static const std::string mCisternSensorShmName;
        static const std::string mOutsideSensorShmName;
        static const std::string mNitrificationSensorShmName;
        static const std::string mSensorAddShmName;
        ...
        static std::unique_ptr<mdbcom::MDBIPCShm> mCisternSensorSharedQueue;
        static std::unique_ptr<mdbcom::MDBIPCShm> mNitrificationSensorSharedQueue;
        static std::unique_ptr<mdbcom::MDBIPCShm> mOutsideSensorSharedQueue;
        static std::unique_ptr<mdbcom::MDBIPCShm> mSensorAddShareQueue;
