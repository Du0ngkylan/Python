...
namespace famsdatautil {
    ...
    public:
		...
		inline std::vector<FAMSDUTaskSummaryData> getTaskData(void) const {
			return taskData;
		}
		...
		inline void setTaskData(std::vector<FAMSDUTaskSummaryData> _taskData) {
			taskData = _taskData;
		}
    private:
        //! id
		...
		std::vector<FAMSDUTaskSummaryData> taskData;
    };
}
