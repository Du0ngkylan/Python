...
/*!
 * @file        FAMSDURqCisternAnalyzer.h
...
#ifndef FAMS_DATA_UTILIZATION_CISTERN_ANALYZER_H_
#define FAMS_DATA_UTILIZATION_CISTERN_ANALYZER_H_
...
namespace famsdatautil {
    ...
    /*!
     * @class FAMSDURqCisternAnalyzer
     * @brief Perform analyzing for input of sensor info search request
     */
    class FAMSDURqCisternAnalyzer : public mdbcom::MDBContentAnalyzer {
    public:
        /*!
         ...
         * @return None.
         */
        FAMSDURqCisternAnalyzer(mdbcom::MDBContentParser *parser);
...
#endif /* FAMS_DATA_UTILIZATION_CISTERN_ANALYZER_H_ */
