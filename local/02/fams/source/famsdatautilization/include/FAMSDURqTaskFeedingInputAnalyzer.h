...
/*!
 * @file        FAMSDURqTaskFeedingInputAnalyzer.h
...
#ifndef FAMS_DATA_UTILIZATION_TASK_FEEDING_INPUT_ANALYZER_H_
#define FAMS_DATA_UTILIZATION_TASK_FEEDING_INPUT_ANALYZER_H_
...
namespace famsdatautil {
    ...
    /*!
     * @class FAMSDURqTaskFeedingInputAnalyzer
     * @brief Perform analyzing for input of sensor info search request
     */
    class FAMSDURqTaskFeedingInputAnalyzer : public mdbcom::MDBContentAnalyzer {
    public:
        /*!
         ...
         * @return None.
         */
        FAMSDURqTaskFeedingInputAnalyzer(mdbcom::MDBContentParser *parser);
...
#endif /* FAMS_DATA_UTILIZATION_TASK_FEEDING_INPUT_ANALYZER_H_ */
