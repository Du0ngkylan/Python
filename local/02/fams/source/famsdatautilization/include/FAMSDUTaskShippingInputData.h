...
/*!
 * @file        FAMSDUTaskShippingInputData.h
 * @brief       request data defination file
 * @author      anhnguyen
 * @date        2018/12/10
 */

#ifndef FAMS_DATA_UTIL_TASK_SHIPPING_INPUT_DATA_H_
#define FAMS_DATA_UTIL_TASK_SHIPPING_INPUT_DATA_H_
...
namespace famsdatautil {
    /*!
     * @class FAMSDUTaskShippingInputData
    ...
    public:
         ...
         * @return None.
         */
        FAMSDUTaskShippingInputData(void) :
        ...
        inline std::string getDestination(void) const {
            return destination;
        }

        inline void setDestination(std::string _destination) {
...
#endif /* FAMS_DATA_UTIL_TASK_SHIPPING_INPUT_DATA_H_ */
