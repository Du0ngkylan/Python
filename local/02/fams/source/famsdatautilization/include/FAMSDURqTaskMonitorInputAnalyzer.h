...
/*!
 * @file        FAMSDURqTaskMonitorInputAnalyzer.h
...
#ifndef FAMS_DATA_UTILIZATION_TASK_MONITOR_INPUT_ANALYZER_H_
#define FAMS_DATA_UTILIZATION_TASK_MONITOR_INPUT_ANALYZER_H_
...
namespace famsdatautil {
    ...
    /*!
     * @class FAMSDURqTaskMonitorInputAnalyzer
     * @brief Perform analyzing for input of sensor info search request
     */
    class FAMSDURqTaskMonitorInputAnalyzer : public mdbcom::MDBContentAnalyzer {
    public:
        /*!
         ...
         * @return None.
         */
        FAMSDURqTaskMonitorInputAnalyzer(mdbcom::MDBContentParser *parser);
...
#endif /* FAMS_DATA_UTILIZATION_TASK_MONITOR_INPUT_ANALYZER_H_ */
