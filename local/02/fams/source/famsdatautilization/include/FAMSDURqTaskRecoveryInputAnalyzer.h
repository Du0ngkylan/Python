...
/*!
 * @file        FAMSDURqTaskRecoveryInputAnalyzer.h
...
#ifndef FAMS_DATA_UTILIZATION_TASK_RECOVERY_INPUT_ANALYZER_H_
#define FAMS_DATA_UTILIZATION_TASK_RECOVERY_INPUT_ANALYZER_H_
...
namespace famsdatautil {
    ...
    /*!
     * @class FAMSDURqTaskRecoveryInputAnalyzer
     * @brief Perform analyzing for input of sensor info search request
     */
    class FAMSDURqTaskRecoveryInputAnalyzer : public mdbcom::MDBContentAnalyzer {
    public:
        /*!
         ...
         * @return None.
         */
        FAMSDURqTaskRecoveryInputAnalyzer(mdbcom::MDBContentParser *parser);
...
#endif /* FAMS_DATA_UTILIZATION_TASK_RECOVERY_INPUT_ANALYZER_H_ */
