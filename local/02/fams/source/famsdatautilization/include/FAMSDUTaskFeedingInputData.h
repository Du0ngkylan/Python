...
/*!
 * @file        FAMSDUTaskFeedingInputData.h
 * @brief       request data defination file
 * @author      anhnguyen
 * @date        2018/12/10
 */

#ifndef FAMS_DATA_UTIL_TASK_FEEDING_INPUT_DATA_H_
#define FAMS_DATA_UTIL_TASK_FEEDING_INPUT_DATA_H_
...
namespace famsdatautil {
    /*!
     * @class FAMSDUTaskFeedingInputData
    ...
    public:
         ...
         * @return None.
         */
        FAMSDUTaskFeedingInputData(void) :
        ...
        inline std::string getFeedingName(void) const {
            return feedingName;
        }

        inline void setFeedingName(std::string _feedingName) {
            feedingName = _feedingName;
        }
        ...
        inline void setDetail(const long long lotId, const std::string amount) {
            details.insert ( std::pair<long long, std::string>(lotId, amount) );
        }

        inline const std::multimap<long long, std::string> &getDetails(void) const {
            return details;
        }
    ...
    private:
        ...
        long long PICId;
        std::string feedingName;
        std::string note;
        std::vector<long long> lotList;
        std::vector<std::string> amountList;
        std::multimap<long long, std::string> details;
    };
}

#endif /* FAMS_DATA_UTIL_TASK_FEEDING_INPUT_DATA_H_ */
