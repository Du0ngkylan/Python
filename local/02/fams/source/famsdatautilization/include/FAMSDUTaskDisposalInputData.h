...
/*!
 * @file        FAMSDUTaskDisposalInputData.h
 * @brief       request data defination file
 * @author      anhnguyen
 * @date        2018/12/10
 */

#ifndef FAMS_DATA_UTIL_TASK_DISPOSAL_INPUT_DATA_H_
#define FAMS_DATA_UTIL_TASK_DISPOSAL_INPUT_DATA_H_
...
namespace famsdatautil {
    /*!
     * @class FAMSDUTaskDisposalInputData
    ...
    public:
         ...
         * @return None.
         */
        FAMSDUTaskDisposalInputData(void) :
        ...
        int getDisposalType() const {
            return disposalType;
        }

        void setDisposalType(int _disposalType) {
...
#endif /* FAMS_DATA_UTIL_TASK_DISPOSAL_INPUT_DATA_H_ */
