...
namespace famsdatareception {
	...
	static constexpr const char* const TIMESTAMP_IF005 = "timeStamp";
	...
	static constexpr const char* const CISTERNCODE_IF005 = "cisternCode";
	...
	static constexpr const char* const PORT{ "port" };
	...
	static const std::string CISTERN_ADD_PATH{ famscommon::API_VERSION_V1 + "/data/sensor/update" };
    /* --------------------------------------------------------- */
